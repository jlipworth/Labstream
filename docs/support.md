...
See [Report a bug](REPORTING-BUGS.md) for the step-by-step guide, including what
the diagnostic report does and does not include.
...
For hard-to-reproduce playback or music issues, you can include a local
diagnostic report:
...
See the [Privacy Policy](privacy.md). VisionPlay collects no data and sends
