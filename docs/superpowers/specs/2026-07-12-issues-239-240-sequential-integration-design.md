...
The existing #237 changes are preserved in a temporary WIP commit. The branch is rebased onto local `main` at `5d369c2`. All subsequent work is performed directly in `/path/to/user/labstream-worktrees/issue-237-trickplay-hover`.
