...
- Local-only, not committed: rename checkout folder from `/path/to/user/plex-avp-app` to `/path/to/user/visionplay` after implementation is committed/pushed or at a deliberate handoff point.
